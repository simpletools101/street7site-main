    ...
    return (
        <div className="min-h-screen bg-white font-sans flex justify-center py-8 sm:py-12 md:py-16 lg:py-20 px-4 sm:px-6 md:px-8">
            ...
            <div className="w-full max-w-4xl">
                ...
                {/* Accent Banner - Desktop */}
                <div className="w-full mb-10 sm:mb-12 md:mb-16 hidden sm:block" style={bannerStyle}></div>
                {/* Accent Banner - Mobile */}
                <div className="w-full mb-8 block sm:hidden" style={bannerStyleMobile}></div>
